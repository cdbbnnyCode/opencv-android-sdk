...
OPENCV_MODULES:=stitching aruco bgsegm bioinspired ccalib dnn_objdetect dnn_superres dpm highgui face fuzzy hfs img_hash line_descriptor quality reg rgbd saliency stereo structured_light phase_unwrapping superres optflow surface_matching tracking datasets text dnn plot videostab video videoio xfeatures2d shape ml ximgproc xobjdetect objdetect calib3d imgcodecs features2d flann xphoto photo imgproc core
